...
2. در پایان، تمام تغییرات را push کنید و لینک ریپو را طبق دستور مدرس ارسال کنید.

موفق باشید! اگر ابهامی بود حتماً از مدرس سؤال کنید. هیچ پاسخ آماده‌ای در این README وجود ندارد؛ همه چیز باید توسط خودتان تکمیل شود. 
# exam1140825
